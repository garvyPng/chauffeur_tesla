...
export const HeroSection = () => {
    ...
    return (
        <section id='home' className='relative h-screen min-h-[600px]'>
            ...
            {/* <SwissIcon className='block md:hidden absolute left-1/2 top-24 z-10 h-10 w-10 -translate-x-1/2 sm:top-28 sm:h-12 sm:w-12' /> */}
            ...
            <Container className='relative' size='lg'>
                <div className='flex  h-screen min-h-[600px] w-full flex-col md:flex-row justify-center md:justify-between md:items-center'>
                    {/* <SwissIcon className='hidden md:block order-1 md:order-2 h-10 w-10 sm:h-12 sm:w-12' /> */}

                    <div className='order-2 md:order-1  z-10 mt-6 space-y-3 sm:max-w-[420px] md:max-w-[500px]'>
                        <h1 className='font-heading lg:w-[900px] sm:w-auto text-3xl leading-tight tracking-tight text-white sm:text-4xl md:text-6xl lg:text-8xl'>
                            {t('hero.title')}
